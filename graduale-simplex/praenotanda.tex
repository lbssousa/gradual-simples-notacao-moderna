...
Para favorecer a prosódia da língua portuguesa, foram empregadas elisões\footnote{Aglutinação de duas ou mais vogais consecutivas de palavras distintas, como se pertencecessem a uma única sílaba.} nos textos fixos, como antífonas e hinos, bem como nos versos salmódicos.
...
\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        \begin{minipage}[c]{8cm}
            \lilypondfile[staffsize=20]{snippets/epi.ly}
        \end{minipage}                                                                      \\
        \hline
        Liquescência                                              &
        \raisebox{-2mm}{\begin{minipage}[c]{3.5cm}
                            ...
                            \end{minipage}} &
        \begin{minipage}[c]{8cm}
            \lilypondfile[staffsize=20]{snippets/liq.ly}
        \end{minipage}                                                                      \\
        \hline
        Quilisma                                                  &
        ...
        \begin{minipage}[c]{5cm}
            \lilypondfile[staffsize=20]{snippets/quil.ly}
        \end{minipage}                                                                     \\
        \hline
        Oriscus                                                   &
        ...
        \begin{minipage}[c]{2cm}
            \lilypondfile[staffsize=20]{snippets/oris.ly}
        \end{minipage}                                                                     \\
        \hline
    \end{tabular}
\end{center}
