...
\SetFirstVersePair{
    {\item \VSup{1}Exsultáte, iusti, in \TerminatioCII{Dó}mino.~\Responsorium}%
        {Exultai, ó justos, no \TerminatioCII{nhor}.~\Responsorium}
}

\SetSecondVersePair{
    {\item \VSup{3}Cantáte ei cánticum \MediatioC{no}[vum,] bene psállite ei in vociferati\TerminatioCII{ó}ne.~\Responsorium}%
        {Cantai para o Senhor um canto \MediatioC{no}[vo,] com arte sustentai a \TerminatioCII{louva}ção!~\Responsorium}
}
...
\SetVersePairs{
    ...
    {\item \VSup{12}Beáta gens, cui Dóminus est \MediatioC{De}[us,] pópulus, quem elégit in hereditátem \TerminatioCII{si}bi.~\Responsorium}%
        {\item \VSup{12}Feliz o povo cujo Deus é \MediatioC{o}[ Senhor,] e a nação que escolheu por sua he\TerminatioCII{ran}ça!~\Responsorium},
    ...
    {\item \VSup{18}Ecce óculi Dómini super metuéntes \MediatioC{e}[um,] in eos qui sperant super misericórdia \TerminatioCII{e}ius.~\Responsorium}%
        {\item \VSup{18}Mas o Senhor pousa o olhar sobre os que o \MediatioC{te}[\-mem,] e que confiam esperando em \TerminatioCII{seu a}mor.~\Responsorium},
    {\item \VSup{20}Ánima nostra sústinet \MediatioC{Dó}[minum,] quóniam adiútor et protéctor \TerminatioCII{noster} est.~\Responsorium}%
        {\item \VSup{20}No Senhor nós esperamos confi\MediatioC{an}[tes,] porque ele é nosso auxílio e \TerminatioCII{prote}ção!~\Responsorium},
