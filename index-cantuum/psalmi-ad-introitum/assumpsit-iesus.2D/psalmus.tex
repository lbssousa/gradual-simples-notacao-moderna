\SetVersePairs{
  ...
  {\item \VSup{11}\Inchoatio{Qui}{a} mélior est dies una in átriis tuis super \Flexa{mí}[lia,] elégi ad limen esse in domo Dei \MediatioII{me}[i,] magis quam habitáre in tabernáculis pec\TerminatioII{ca}{tó}rum.~\Antiphona}%
    {\item \VSup{11}\Inchoatio{Na}[ ]{ver}dade, um só dia em vosso \MediatioII{tem}[plo] vale mais do que milhares fo\TerminatioII{ra}[ ]{de}le! \Sequitur{Pre}firo eMediatioMark no limiar de vossa \MediatioII{ca}[sa,] a hospedar-me na mansão dos pe\TerminatioII{ca}{do}res!~\Antiphona},
