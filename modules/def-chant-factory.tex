...
\NewDocumentCommand \MakeChantAntiphon { s m O{} } {
  ...
  \lilypondfile{index-cantuum/antiphonae/#2/\@Antiphon@L}
}

\NewDocumentCommand \MakeChantAlleluia { s m O{} } {
  \def\@Antiphon@L{antiphona}

  \lilypondfile{index-cantuum/antiphonae/alleluia.#2/\@Antiphon@L}
...
\NewDocumentCommand \MakeChantPsalm { m m } {
  \lilypondfile{index-cantuum/#1/#2/psalmus}
}
...
\NewDocumentCommand \MakeChantHymn { m m } {
  \lilypondfile{index-cantuum/#1/#2/hymnus}
}
