...
\def\@Lily@Staff@Size{24}

\NewDocumentCommand \MakeChantAntiphon { s m O{} } {
  \def\@Antiphon@L{antiphona\IfBlankF{#3}{.#3}}

  \lilypondfile[staffsize=\@Lily@Staff@Size]{index-cantuum/antiphonae/#2/\@Antiphon@L}
}

\NewDocumentCommand \MakeChantAlleluia { s m O{} } {
  \def\@Antiphon@L{antiphona}

  \lilypondfile[staffsize=\@Lily@Staff@Size]{index-cantuum/antiphonae/alleluia.#2/\@Antiphon@L}
...
\NewDocumentCommand \MakeChantPsalm { m m } {
  \lilypondfile[staffsize=\@Lily@Staff@Size]{index-cantuum/#1/#2/psalmus}
}
...
\NewDocumentCommand \MakeChantHymn { m m } {
  \iftoggle{onecolumn}{
    \GregorioImportR{index-cantuum/#1}{#2}{psalmus-v1}{psalmus-v1-pt}
  }{
    \begin{paracol}{2}
      \GregorioImportLR{index-cantuum/#1}{#2}{psalmus-v1}{psalmus-v1-pt}
    \end{paracol}
  }
}
