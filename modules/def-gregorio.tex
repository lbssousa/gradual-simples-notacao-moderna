...
\newcommand{\VSup}[1]{\textsuperscript{\upshape\color{gregoriocolor}#1}}
...
\NewDocumentCommand \ResponsoriumC {} {%
  \allowbreak\textcolor{gregoriocolor}{\Rbar.}~\GreMediatioMark%
}
...
{\IfValueTF{#3}{\textbf{#2}#3}{\textbf{#2}}~\GreFlexaMark}%
}
...
\NewDocumentCommand{\MediatioNil}{m}{#1~\GreMediatioMark}

\NewDocumentCommand{\MediatioI}{m m m O{}}{%
  \textbf{#1}#2\textbf{#3}#4~\GreMediatioMark%
}
...
\NewDocumentCommand{\MediatioVI}{m O{} m O{}}{%
  \textit{#1}#2\textbf{#3}#4~\GreMediatioMark%
}
